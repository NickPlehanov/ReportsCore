...
namespace ReportsCore.Models
{
    ...
    public partial class NewGuardObjectExtensionBase
    {
        ...
        [InverseProperty(nameof(SystemUserBase.NewGuardObjectExtensionBaseNewCuratorNavigation))]
        public virtual SystemUserBase NewCuratorNavigation { get; set; }
        [ForeignKey(nameof(NewCuratorUserMount))]
        [InverseProperty(nameof(SystemUserBase.NewGuardObjectExtensionBaseNewCuratorUserMountNavigation))]
        public virtual SystemUserBase NewCuratorUserMountNavigation { get; set; }
        [ForeignKey(nameof(NewGuardObjectId))]
        [InverseProperty(nameof(NewGuardObjectBase.NewGuardObjectExtensionBaseNewGuardObject))]
